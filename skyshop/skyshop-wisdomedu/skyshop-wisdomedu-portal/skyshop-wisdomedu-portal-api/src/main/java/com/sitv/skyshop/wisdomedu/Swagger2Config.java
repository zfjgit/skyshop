...
public class Swagger2Config {
	...
	public Docket createRestApi() {
		...
		// tokenPar.name("123").defaultValue("***").description("token").modelRef(new
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("wisdomedu").description("skyshop wisdomedu api").termsOfServiceUrl("https://github.com/zfjgit/skyshop/tree/master/skyshop/")
