package com.sitv.skyshop.tbataobao.check;
...
public class Swagger2Config {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("tbataobao").description("skyshop tbataobao api").termsOfServiceUrl("https://github.com/zfjgit/skyshop/tree/master/skyshop/")
