...
var config = {
    ...
    pay_server_url : 'http://kehu.tba-taobao.com/WXPayAPI_QQT/PayJsAPIOpenid.aspx',
...
function get(url, data, successfunc, runtimeerrorfunc) {
    ...
    doAjax(url, data, handler, 'GET', runtimeerrorfunc);
}
...
function doAjax(url, data, successfunc, method, runtimeerrorfunc, async, errorfunc, loadingText, showloadingfunc, hideloadingfunc, beforefunc, completefunc) {
    if (config.is_debug) {
    ...
    $
        .ajax({
            ...
            success : function(result, textStatus, jqXHR) {
                if (hideloadingfunc && typeof hideloadingfunc == 'function') {
                    hideloadingfunc();
                } else {
                    $.hideLoading();
                }
            ...
            beforeSend : function(xhr) {
                if (showloadingfunc && typeof showloadingfunc == 'function') {
                    showloadingfunc();
                } else {
