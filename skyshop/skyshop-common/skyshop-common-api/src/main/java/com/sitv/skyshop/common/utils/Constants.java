...
public final class Constants {
	...
	public static final String SMS_URL = "https://sms.yunpian.com/v2/sms/single_send.json";
	public static final String SMS_APIKEY = "";
	public static final String SMS_NEWORDER = "";
	public static final String SMS_RPDOCUTSEND = "";
